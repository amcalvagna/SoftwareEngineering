...
class BinaryTree implements IBinaryTree {
    ...
    public Iterator<IBinaryTree> iterator() { return new InOrderBSTIterator(this); }

    public Iterator<IBinaryTree> inOrderBSTIterator() {
		return new InOrderBSTIterator(this);
	}
	
	public Iterator<IBinaryTree> preOrderBSTIterator() {
		return new PreOrderBSTIterator(this);
	}
	
	public Iterator<IBinaryTree> postOrderBSTIterator() {
		return new PostOrderBSTIterator(this);
	}
