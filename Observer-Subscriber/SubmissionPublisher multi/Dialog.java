...
//import OberverApp.AddrBook;
//import OberverApp.Persona;
//import OberverApp.Store;

public class Dialog {

    // creo addresbook con abbinata coda di submission subpub n.1
    private static SubmissionPublisher<Persona> publisher = new SubmissionPublisher<>();
    private static final AddrBook book2 = new AddrBook(publisher);
    
    // metto altre notifiche sulla stessa coda di sottomissioni
    private static final AddrBook book1 = new AddrBook(publisher);
    // *********** oppure *********** creo una seconda coda di submissions subPub n.2 
    ...
    // creo tre item Persona da trasmettere (messaggi)
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.in.read();
        // collego il secondo ed un terzo subsciber al secondo book
        //book2.attach(st2); // ******* solo se non già sottoscritto... ***********
        book2.attach(st3);
