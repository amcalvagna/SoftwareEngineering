...
// In questa variante ogni store esegue il bkp storage di più address books  
// sarò subcriber di più subscriptions
...
public class Store implements Subscriber<Persona> {
    ...
    public void onSubscribe(Subscription s) {
        // a subscription is a message queue created by the publisher 
        // for notification/messages sent to a specific subscriber 
        //  subscribers can { request(n) / cancel() } that is,
        // stop future calls of onNext or process the queued messages at their own pace
        this.subList.add(s);
