...
public class Parameters05 {
   Integer graduationYear = 2015;
    ...
    private static boolean test2014(Function<String, Boolean> f){ 
        return f.apply("2014");
    }

    void foo () { 
         // get functional method as return value and pass it as argument to local method test()  
        Function<String,Boolean> ff = (new Student(10,2014)).getff();
        System.out.println( "test2="+ test2014(ff));
        //equivalent to:
        System.out.println( "test1="+ test2014(s -> Integer.parseInt(s) == this.graduationYear));        
    }

    public static void main(String args[]) {
       List<Student> students = Student.createList();

       new Parameters05().foo();  // show lambdas use as return values
