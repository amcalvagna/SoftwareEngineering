...
// ========================================================
    ...
    public void ex25_insertBeginningAndEnd() {
        Stream<String> input = Arrays.asList(
                "a", "b", "c", "d", "e", "f", "g", "h", "i", "j",  
                "k", "l", "m", "n", "o", "p", "q", "r", "s", "t")
                .parallelStream();  // ad es. creo in parallelo aa bb cc ... 
                // usando la funzione1 per unire uno StrinBuilder vuoto ad una stringa ottenendo un nuovo SB 
                // ricordandomi chi tra loro viene prima o dopo: unisco poi gli SB in parallelo ma rispettando l'ordine  
                // produco jihgfedcbaabcdefghij tsrqponmlkklmnopqrst e aggiungo il mezzo iniziale di quello che viene ordinalmente dopo (sb2)
                // davanti a quello che viene prima (sb1), e il mezzo finale di sb2 dietro sb1 sb2/2:sb1:sb2/2
...
// ========================================================
     ...
     */
    // ovvero da mappa raggruppata a lista di coppie (animale, zampe)
    @Test
...
//                .collect(toList());
    ...
    public void ex27_parallelVsSequential() {
        ...
        System.out.println("adder1 = "+adder1.get());
        System.out.println("adder2 = "+adder2.get());
